...
return [
    //News
    'NewsHeadTitle' => 'الأخبار - لعبة سباق الهجن',
    'NewsHeading' => 'أخبار سباق الهجن',
    //Contact
    'ContactPageTitle' => 'تواصل معنا - لعبة سباق الهجن',
    'ContactUsHeading' => 'تواصل معنا',
    'ContactUsP' => 'أخبرنا أي شيئ , نحن هنا للمساعدة',
    'Name' => 'الاسم :',
    'NamePlaceholder' => 'أدخل اسمك هنا',
    'ContactMethod' => 'طريقة الاتصال :',
    'ContactMethodPlaceholder' => 'البريد الإلكتروني او رقم الهاتف',
    'Message' => 'الرسالة :',
