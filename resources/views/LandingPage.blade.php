...
<body>
    ...
    <section class="hijen-characters">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <h3 class="section-heading">{{__('LandingPage.HijenCharachters')}}</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
        ...
        <section class="downloads" id="downloads">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12 col-sm-12">
                    ...
                    <a href="https://apps.apple.com/us/app/%D8%B3%D8%A8%D8%A7%D9%82-%D8%A7%D9%84%D9%87%D8%AC%D9%86-2020/id1489191603?ls=1" target="_blank" class="download-btn"><img src="{{asset('public/images')}}/app-store.svg"
                          alt="Donwload From Google Play"></a>
                </div>
            </div>
        </section>
    </div>
