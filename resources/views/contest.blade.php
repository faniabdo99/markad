...
<body>
    ...
    <div class="container-fluid">
        <section class="contest-content @lang('LandingPage.textClass')" dir="@lang('LandingPage.dir')">
            ...
            <p>قم باكمال مراحل اللعب الفردي و اليطولة بأفضل أداء ممكن لتتمكن من الفوز ! سيحصل أفضل 3 لاعبين على جوائز مميزة بالإضافة الى مبالغ نقدية</p>
                    ...
                    <div class="col-md-4 col-xs-12 col-sm-6">
                        <div class="prize-card">
                            ...
                            <div class="prize-card-content @lang('LandingPage.textClass')" dir="@lang('LandingPage.dir')">
                                ...
                                <p>السيف العربي دليل القوة , هذه الجائزة بالإضافة الى مبلغ 1500 درهم اماراتي ستصلك في العالم الحقيقي لتكون الدليل الدامغ على تفوقك في سباق الهجن !</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12 col-sm-6">
                    <div class="prize-card">
                        ...
                        <div class="prize-card-content @lang('LandingPage.textClass')" dir="@lang('LandingPage.dir')">
                            ...
                            <h2>بندقية</h2>
                            <p>إضافة الى مبلغ 1000 درهم اماراتي ستحصل على هذه البندقية الرائعة ! لن يستطيع أحد التشكيك في بطولتك بعد الآن ! , هل يمكنك اثبات أنك جدير بهذه البندقية ؟</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-xs-12 col-sm-6">
                <div class="prize-card">
                    ...
                    <div class="prize-card-content @lang('LandingPage.textClass')" dir="@lang('LandingPage.dir')">
                        ...
                        <h2>كأس التفوق</h2>
                        <p>الكأس هو الجائزة الأهم حول العالم , هي الدليل القاطع على التفوق , تفوق على اللاعبين في لعبة سباق الهجن لتحصل على هذه الجائزة بالإضافة الى مبلغ 500 درهم اماراتي</p>
                </div>
            </div>
    </div>
    </div>
