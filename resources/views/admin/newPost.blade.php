...
<body class="admin-body">
    ...
    <main>
        @php $PageName = "اضافة مقال جديد" @endphp
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <div class="admin-card">
                        ...
                        <form action="{{ route('admin.UploadPost') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="new-post-group">
                                <label>عنوان المقال</label>
                                <input maxlength="255" value="{{old('p_title')}}" type="text" name="p_title" @if (old('p_title')) value="{{old('p_title')}}" @endif >
                            ...
                            <div class="new-post-group">
                                ...
                                <input maxlength="255" dir="rtl" type="text" name="p_slug" @if (old('p_slug')) value="{{old('p_slug')}}" @endif >
                            ...
                            <div class="new-post-group">
                                ...
                                <input maxlength="255" type="text" name="p_keywords" @if (old('p_keywords')) value="{{old('p_keywords')}}" @endif >
                            ...
                            <div class="new-post-group">
                                ...
                                <textarea maxlength="799" rows="3" name="p_description"> @if (old('p_description')) {{old('p_description')}} @endif </textarea>
                                <p class="tip">ينصح أن لا يزيد عن 255 حرف وأن يحتوي الكلمة المفتاحية , هذا الحقل هو شرح بسيط وليس المقال بحد ذاته</p>
                            </div>
                         
                            <div class="new-post-group">
                                <label>محتوى المقال</label>
                                <textarea name="p_body" id="editor"> @if (old('p_body')) {{old('p_body')}} @endif </textarea>
                            </div>
                            <div class="new-post-group">
