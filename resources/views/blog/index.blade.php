        ...
        <div class="row">
            <div class="col">
                <section class="news-top-hero {{__('LandingPage.textClass')}}" dir="{{__('LandingPage.dir')}}">
                    ...
                    <div class="main-post" style="background:url('{{asset('public/images/blog')}}/{{$SuperImportant->p_image}}') no-repeat center center;">
                    ...
                    <div class="news-secondary-post {{__('LandingPage.textClass')}}" dir="{{__('LandingPage.dir')}}" style="background:url('{{asset('public/images/blog')}}/{{$ImportantPost->p_image}}') no-repeat center center;">
